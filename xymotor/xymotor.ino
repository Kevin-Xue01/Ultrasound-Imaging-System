...
// User variables
int x_motor_travel_percentage = 101; // percentage of x axis travel 
float x_motor_pixel_percentage = 0.65; // percentage of x_motor_total steps for 1 pixel

int y_motor_travel_percentage = 98; // percentage of x axis travel 
